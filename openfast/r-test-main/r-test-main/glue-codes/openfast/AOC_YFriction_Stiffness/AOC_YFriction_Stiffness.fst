...
---------------------- FEATURE SWITCHES AND FLAGS ------------------------------
          ...
          0   CompInflow      - Compute inflow wind velocities (switch) {0=still air; 1=InflowWind; 2=external from ExtInflow}
          0   CompAero        - Compute aerodynamic loads (switch) {0=None; 1=AeroDisk; 2=AeroDyn; 3=ExtLoads}
...
---------------------- INPUT FILES ---------------------------------------------
"AOC_YFriction_Stiffness_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"unused"      BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"unused"      BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"unused"      BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"AOC_YFriction_Stiffness_InflowWind.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"AOC_YFriction_Stiffness_AeroDyn.ipt"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"AOC_YFriction_Stiffness_ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
