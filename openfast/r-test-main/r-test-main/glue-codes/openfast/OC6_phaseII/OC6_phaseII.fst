...
OpenFAST model: OC6 phase II. ElastoDyn+SubDyn approach for tower and monopile. Gravity-only case with still water. Definition of the system available here: https://www.nrel.gov/docs/fy21osti/79938.pdf. Results from the model should be similar to Figure 4 from https://onlinelibrary.wiley.com/doi/full/10.1002/we.2698    
---------------------- SIMULATION CONTROL --------------------------------------
...
---------------------- FEATURE SWITCHES AND FLAGS ------------------------------
          ...
          1   CompSoil        - Compute soil-structural dynamics (switch) {0=None; 1=SoilDyn}
...
---------------------- INPUT FILES ---------------------------------------------
"OC6_phaseII_ElastoDyn.dat"          EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"OC6_phaseII_ServoDyn.dat"           ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"OC6_phaseII_SeaState.dat"           SeaStFile       - Name of file containing sea state input parameters (quoted string)
"OC6_phaseII_HydroDyn.dat"           HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"OC6_phaseII_Monopile_SubDyn.dat"    SubFile         - Name of file containing sub-structural input parameters (quoted string)
"unused"                             MooringFile     - Name of file containing mooring system input parameters (quoted string)
"unused"                             IceFile         - Name of file containing ice input parameters (quoted string)
"OC6_phaseII_SoilDyn.dat"            SoilFile        - Name of the file containing the SoilDyn input parameters (quoted string)
---------------------- OUTPUT --------------------------------------------------
...
"ES13.6E2"    OutFmt          - Format used for text tabular output, excluding the time channel.  Resulting field should be 10 characters. (quoted string)
---------------------- LINEARIZATION -------------------------------------------
