...
---------------------- INPUT FILES ---------------------------------------------
"WP_Stationary_Linear_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"WP_Stationary_Linear_AeroDyn.ipt"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"WP_Stationary_Linear_ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
