...
Modal damping for beam rotated and rotating through partial cycle
---------------------- SIMULATION CONTROL --------------------------------------
false         Echo            - Echo input data to <RootName>.ech (flag)
"FATAL"       AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
        0.6   TMax            - Total run time (s)
...
---------------------- INPUT FILES ---------------------------------------------
"../Damped_Beam/ElastoDyn-rotated.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"../Damped_Beam/BeamDyn.dat"    BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
...
False         CalcSteady      - Calculate a steady-state periodic operating point before linearization? [unused if Linearize=False] (flag)
      ...
      0.001   TrimTol         - Tolerance for the rotational speed convergence [used only if CalcSteady=True] (-)
       ...
       0.25   LinTimes        - List of times at which to linearize (s) [1 to NLinTimes] [used only when Linearize=True and CalcSteady=False]
