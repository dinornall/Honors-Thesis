...
---------------------- FEATURE SWITCHES AND FLAGS ------------------------------
          ...
          2   CompIce         - Compute ice loads (switch) {0=None; 1=IceFloe; 2=IceDyn}
...
"../5MW_Baseline/IceDyn_Input.dat"      IceFile         - Name of file containing ice input parameters (quoted string)
