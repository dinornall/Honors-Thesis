...
---------------------- INPUT FILES ---------------------------------------------
"WP_VSP_WTurb_PitchFail_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"WP_Baseline_AeroDyn.dat"           AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"WP_VSP_WTurb_PitchFail_ServoDyn.dat" ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
