...
FAST Certification Test : NREL 5.0 MW Baseline Wind Turbine with OC3 Monopile RF Configuration, for use in offshore analysis (SoilDyn)
---------------------- SIMULATION CONTROL --------------------------------------
...
"5MW_OC3Mnpl_Sld_REDWIN_SoilDyn.dat"              SoilFile       - Name of the file containing the SoilDyn input parameters (quoted string)
---------------------- OUTPUT --------------------------------------------------
