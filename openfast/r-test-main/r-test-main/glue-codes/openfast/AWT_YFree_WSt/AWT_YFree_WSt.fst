...
---------------------- INPUT FILES ---------------------------------------------
"AWT_YFree_WSt_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"AWT_YFree_WSt_AeroDyn.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
