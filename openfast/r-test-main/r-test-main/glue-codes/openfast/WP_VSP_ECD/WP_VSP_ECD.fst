...
---------------------- INPUT FILES ---------------------------------------------
"WP_VSP_ECD_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"WP_VSP_ECD_ServoDyn.dat"           ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
